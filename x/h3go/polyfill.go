...
var (
	...
	maxEdgeLengthRads = [MaxResolution + 1]float64{
	...
	res0BBoxesRads = [NumBaseCells]bbox{
	...
	validRangeBBox = bbox{north: halfPiDeg, south: -halfPiDeg, east: piDeg, west: -piDeg}
)
